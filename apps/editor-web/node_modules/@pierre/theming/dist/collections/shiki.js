...
//#region src/collections/shiki.ts
...
const SHIKI_THEME_DESCRIPTORS = Object.freeze([...LIGHT_SHIKI_THEMES.map((name) => createShikiTheme(name)), ...DARK_SHIKI_THEMES.map((name) => createShikiTheme(name))]);
const shikiThemes = createThemeCollection({ themes: SHIKI_THEME_DESCRIPTORS });
