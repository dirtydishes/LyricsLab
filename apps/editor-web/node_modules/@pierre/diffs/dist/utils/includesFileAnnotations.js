...
const FILE_ANNOTATION_DOM_KEY = `${FILE_ANNOTATION_HUNK_INDEX},${FILE_ANNOTATION_LINE_INDEX}`;
function includesFileAnnotations(annotations) {
	return annotations?.some((annotation) => annotation.lineNumber === FILE_ANNOTATION_LINE_NUMBER) ?? false;
}
